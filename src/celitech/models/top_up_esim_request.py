...
class TopUpEsimRequest(BaseModel):
    ...
    :type iccid: str
    :param data_limit_in_gb: Size of the package in GB. - **Limited Packages (1, 2, 3, 5, 8, 20GB):** supports `duration` or `startDate` `endDate`. - **Unlimited Packages (Region-3 only)** support `duration` only. Use **-1** for unlimited.
