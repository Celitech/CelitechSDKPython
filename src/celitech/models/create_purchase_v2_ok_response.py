...
class CreatePurchaseV2OkResponseProfile(BaseModel):
    ...
    :param activation_code: activation_code, defaults to None
    :type activation_code: str, optional
    """

    def __init__(
        self, iccid: str = SENTINEL, activation_code: str = SENTINEL, **kwargs
    ):
        """CreatePurchaseV2OkResponseProfile
        ...
        self.activation_code = self._define_str(
            "activation_code", activation_code, nullable=True
        )
        self._kwargs = kwargs
